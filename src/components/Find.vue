<template>
  <div>
    ...
    <div style="margin-top:60px;z-index:1;">
      <img src="../animals/cat4.jpg" style="width: 90%; height: 180px; border-radius: 20px" />
    </div>
    <!-- 领养模块 -->
    <div style="
        display: grid;
...
import find1 from "../find/find1.vue";
export default {
  components: {
    find1,
  },
  setup () {
    ...
    function click () {
      ...
      axios.post('http://pawfeet.top:8080/selectPetByMap' + query_str).then((res1) => {
        list.value = res1.data;
        console.log(list.value);
      });
